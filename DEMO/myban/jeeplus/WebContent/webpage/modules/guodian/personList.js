		  ...
		  //请求方法
			...
			,{
		        	 ...
		        	 sortable: true
                       ...
                       field: 'devicedata.device.deviceId',
                       title: '设备号',
                       sortable: true
			},{
                       field: 'title',
                       ...
                       field: 'personProject.personner',
                       title: '人员分类颜色',
                       sortable: true,
                       formatter:function(value, row , index){
                         return jp.getDictLabel(${fns:toJson(fns:getDictList('persontype'))}, value, "-");
                       }
			...
			,{
		        ...
		        sortable: true
                       ...
                       field: 'personHidedate',
                       title: '在职时间',
                       sortable: true

             },{
                       field: 'personProject.quit',
                       title: '状态',
                       sortable: true,
                       formatter:function(value, row , index){
                           if(value=='0'){
                       ...
                       sortable: true,
                       formatter:function(value, row , index){
                           return "<a href='${ctx}/person/person/details?id="+row.id+"'>详情</a>" +
							   "&nbsp;&nbsp;<a href='${ctx}/devicedata/devicedata/dynamic?id="+row.id+"'>动态</a>";
                       }
               }
		     ]
