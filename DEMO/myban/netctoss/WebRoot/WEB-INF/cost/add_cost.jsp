...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function showResult() {
            	//提交表单
            	//form元素上带有submit事件，用于提交表单，而点击submit按钮时，会自动触发此事件。也可以通过js手动触发此事件。
            	//.forms返回页面上所有的表单(数组)
            	document.forms[0].submit();
            	
            	
                //提交表单后页面会刷新，刷新后下面2句提示信息代码不会执行。将来学习了Ajax后可以实现这样的操作。
            	//showResultDiv(true);
    ...
    <body>
        ...
        <div id="main">            
            ...
            <!-- 当前页面：/netctoss/cost/toAdd.do -->
            <!-- 目标页面：/netctoss//cost/add.do -->
