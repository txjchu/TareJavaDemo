...
INSERT INTO COST VALUES (5,'计时收费',null,null,0.5,0,'0.5元/时,不使用不收费',DEFAULT,DEFAULT,'2');
INSERT INTO COST VALUES (6,'包月',null,20,null,0,'每月20元,不限制使用时间',DEFAULT,DEFAULT,'2');
COMMIT;

select *from cost;
update cost set cost_type='1' where cost_id=6;
commit;
update cost set cost_type='3' where cost_id=5;
