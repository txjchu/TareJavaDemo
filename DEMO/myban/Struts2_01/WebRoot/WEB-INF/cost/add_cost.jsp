...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript" type="text/javascript">
        	...
        	function check_name(){
        		...
        		//校验资费名是否为空
        		if(cost_name == ""){
        			$("#cost_name").text("资费名不能为空！").addClass("error_msg");
        			return;//直接返回
        		}
        		//异步请求检查资费名是否为空
        		$.post(
        			"checkcostname",
        			{"name":cost_name},//json字符串形式发送cost_name中的资费名
        			function(data){
        				//回调函数的参数就是返回info属性
        				var info = data;
        				//根据返回值设置提示信息
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="addcost.action" method="post" class="main_form">
                <div class="text_info clearfix"><span>资费名称：</span></div>
                <div class="input_info">
                <!-- 
                    <input type="text" class="width300" id="cost_name" onblur="check_name();"/>
                 -->
                    <s:textfield name="cost.name" cssClass="width300" onblur="check_name();"/>
                    <span class="required">*</span>
                    <div class="validate_msg_short" id="name_msg">50长度的字母、数字、汉字和下划线的组合</div>
                </div>
                <div class="text_info clearfix"><span>资费类型：</span></div>
                <div class="input_info fee_type">
                    <s:radio name="cost.costType" list="#{'1':'包月','2':'套餐','3':'计时'}" onclick="feeTypeChage(this.value)"/>
                </div>
