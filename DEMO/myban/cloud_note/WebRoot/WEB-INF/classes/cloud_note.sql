...
select cn_notebook_id from cn_notebook where cn_notebook_name='第一天';
select cn_notebook_name from cn_notebook ;
select * from cn_user;
select * from cn_note;
select * from cn_notebook;
select * from cn_note where cn_note_title='aaa1';
select cn_note_id,cn_note_title,cn_notebook_id from cn_note where cn_user_id='48595f52-b22c-4485-9244-f4004255b972';
select cn_notebook_id from cn_notebook where cn_notebook_name='action';
select cn_note_title from cn_note where cn_notebook_id='1b05c9c7-f1cd-4842-beae-15ed95a1febb';
update cn_note set cn_note_status_id='1' ;
update cn_user set cn_user_password='123456';
update cn_note set cn_note_status_id='1' where cn_note_status_id is null;
